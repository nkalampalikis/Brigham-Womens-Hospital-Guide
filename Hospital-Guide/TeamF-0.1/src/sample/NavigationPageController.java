...
import sample.PathFinder.Map;
import sample.PathFinder.Node;
import sample.PathFinder.SearchEngine;
...
public class NavigationPageController implements Initializable, Data{
    ...
    private sample.PathFinder.Map CurMap;
...
*/
    ...
    public void setMap(sample.PathFinder.Map m) throws IOException{
        this.CurMap = m;
